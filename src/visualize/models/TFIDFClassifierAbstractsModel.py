...
class TFIDFClassifierAbstractsModel(AbstractModel):
    ...
    ##########################################
    def __init__(self,classifier,min_df=0,max_df=1.0,recs=10,ngram_range=(1,4),max_features=850000,concat=True):
        ...
        self.path = os.path.join(".", "data","model_tfidf_classifier")
