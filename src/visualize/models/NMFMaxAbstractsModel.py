...
class NMFMaxAbstractsModel(AbstractModel):
    ...
    ##########################################
    def __init__(self,topics=5,beta_loss="frobenius",solver="cd",alpha=1,random_state=0,verbose=True,init="random",max_iter=5,min_df=0,max_df=1.0,recs=10):
        ...
        self.path = os.path.join(".", "data", "model_nmf_max")
