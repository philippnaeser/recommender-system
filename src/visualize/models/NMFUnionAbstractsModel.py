# -*- coding: utf-8 -*-
"""
Created on Sun Aug  5 21:10:07 2018
...
class NMFUnionAbstractsModel(AbstractModel):
    
    ##########################################
    def __init__(self,topics=10,beta_loss="kullback-leibler",solver="mu",alpha=0,random_state=0,verbose=True,init="random",max_iter=10,min_df=10,max_df=1.0,recs=10):
        ...
        self.path = os.path.join(".","data","model_nmf_union")
