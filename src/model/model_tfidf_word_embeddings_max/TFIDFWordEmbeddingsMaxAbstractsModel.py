# -*- coding: utf-8 -*-
"""
Created on Tue Aug 14 00:55:37 2018
...
class TFIDFWordEmbeddingsMaxAbstractsModel(AbstractModel):
    ...
    def __init__(self, embedding_model, pretrained = True, recs=10):
        ...
        self.path = os.path.join("..","..","..","data","processed","model_tfidfwordembeddings_max")
