# -*- coding: utf-8 -*-
"""
Created on Tue Aug 14 00:56:25 2018
...
from TFIDFWordEmbeddingsMaxAbstractsModel import TFIDFWordEmbeddingsMaxAbstractsModel

# Generate model (main + child process).

model = TFIDFWordEmbeddingsMaxAbstractsModel(
